...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
    ...
    <!-- ******************     templates for text (listPerson, org, particDesc)     ************************ -->
    <xsl:template match="tei:text/tei:body/tei:listPerson  | tei:text/tei:body/tei:org  | tei:text/tei:body/tei:particDesc">
